...
ALL_COUNTRIES_FOR_SELECTION = {
    "UA": "Україна", "PL": "Польща", "DE": "Німеччина", "LT": "Литва",
    "LV": "Латвія", "EE": "Естонія", "CZ": "Чехія", "SK": "Словаччина",
    "HU": "Угорщина", "RO": "Румунія", "MD": "Молдова", "BG": "Болгарія",
    "TR": "Туреччина", "GR": "Греція", "IT": "Італія", "ES": "Іспанія",
    "PT": "Португалія", "FR": "Франція", "BE": "Бельгія", "NL": "Нідерланди",
    "AT": "Австрія", "CH": "Швейцарія", "GB": "Велика Британія", "IE": "Ірландія",
    "NO": "Норвегія", "SE": "Швеція", "FI": "Фінляндія", "DK": "Данія",
    "BY": "Білорусь", "KZ": "Казахстан", "UZ": "Узбекистан", "GE": "Грузія",
    "AZ": "Азербайджан", "AM": "Вірменія", "AE": "ОАЕ", "AL": "Албанія",
    "AD": "Андорра", "AF": "Афганістан", "AO": "Ангола", "AR": "Аргентина",
}
